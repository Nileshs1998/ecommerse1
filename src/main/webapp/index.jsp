	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To online Store</h1>
			<!-- Icon Divider-->
			...
			<p class="masthead-subheading font-weight-light mb-0">
				Single Store Multiple option</p>
		</div>
	</header>
	<!-- Portfolio Section-->
			...
			<div class="row justify-content-center">
				...
				<div class="col-md-6 col-lg-4 mb-5">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="assets/img/portfolio/earphone.jpg"
							alt="..." />
					</div>
				</div>
				<!-- Portfolio Item 2-->
				<div class="col-md-6 col-lg-4 mb-5">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="assets/img/portfolio/fastWatch.jpg"
							alt="..." />
					</div>
				</div>
				<!-- Portfolio Item 3-->
				<div class="col-md-6 col-lg-4 mb-5">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="assets/img/portfolio/headphone.jpg"
							alt="..." />
					</div>
				</div>
				<!-- Portfolio Item 4-->
				<div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="assets/img/portfolio/iphone.jpg"
							alt="..." />
					</div>
				</div>
				<!-- Portfolio Item 5-->
				<div class="col-md-6 col-lg-4 mb-5 mb-md-0">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="assets/img/portfolio/RolexWyach.jpg"
							alt="..." />
					</div>
				</div>
				<!-- Portfolio Item 6-->
				<div class="col-md-6 col-lg-4">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="assets/img/portfolio/Samsung.jpg"
							alt="..." />
					</div>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Thank you for always stepping in to help when I need you most.
					 Thank you for taking the time to help me, it really meant a lot. Thank you for sharing your home with me, I had such a great time catching up. My stomach (and I) want to thank you for that delicious meal.
					 You made me feel so at home that I forgot I wasn't!
						</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">thanks you
	...
	<footer class="footer text-center">
		<div class="container">
			<div class="row">
				...
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">About Shop</h4>
					<p class="lead mb-0">
						We are providing the Good Services as well the Goods
						by <a href="http://startbootstrap.com">Nilesh</a> .
					</p>
				</div>
			</div>
		</div>
